...
const StudyIcon = ({ w = 60, h = 60 }: IProps) => {
  return (
    <svg
      fill="#000000"
      height={`${h}px`}
    ...
    >
      <g>
        ...
        <path
          d="M231.003,428.057L125.293,287.333c-2.999,6.451-7.078,12.299-12.013,17.307l93.433,124.379
        ...
        <g>
          <path
            d="M219.11,263.944L462,150.683c-22.935-49.184-65.506-81.924-110.798-90.774C327.053,22.957,294.196,0,265.819,0
          ...
          />
          <path
            d="M194.215,90.81L82.187,201.323c7.271,1.531,14.067,4.359,20.15,8.217l96.116-94.817
			C196.5,106.632,195.088,98.64,194.215,90.81z"
          />
          <path
            d="M189.464,144.835L114.079,219.2c4.672,4.922,8.538,10.609,11.389,16.858l57.983-57.198

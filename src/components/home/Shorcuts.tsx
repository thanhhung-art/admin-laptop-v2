          ...
          <tbody>
            <tr>
              {shortcuts[0].map((shortcut) => (
                <td
                  className="p-12 cursor-pointer border text-center hover:bg-slate-200 font-semibold"
                  key={shortcut}
                >
                  {shortcut}
                </td>
            ...
            <tr>
              {shortcuts[1].map((shortcut) => (
                <td className="p-12 border hover:bg-slate-200 font-semibold" key={shortcut}>
